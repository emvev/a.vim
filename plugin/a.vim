...
call <SID>AddAlternateExtensionMapping('h',"c,cpp,cxx,cc,CC,inl")
call <SID>AddAlternateExtensionMapping('H',"C,CPP,CXX,CC,INL")
...
call <SID>AddAlternateExtensionMapping('CXX',"H")
call <SID>AddAlternateExtensionMapping('inl',"h,hpp")
call <SID>AddAlternateExtensionMapping('INL',"H,HPP")
" Mappings for PSL7
